...
class PSYEditProfileScreen extends StatefulWidget {
  const PSYEditProfileScreen({super.key});

  @override
  State<PSYEditProfileScreen> createState() => _PSYEditProfileScreenState();
}

class _PSYEditProfileScreenState extends State<PSYEditProfileScreen> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController(text: 'Галия Аубакирова');
